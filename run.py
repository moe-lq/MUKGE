...
parser.add_argument('--epoch', type=int, default=10, help="set number of epochs. default: 100")
...
# load data
this_data = Data()
if("reverse" in param.whichdata ):
    this_data.pre_load_data(filename=file_train)
    this_data.pre_load_data(filename=file_val)
    this_data.pre_load_data(filename=file_psl)
    this_data.pre_load_data(filename=file_test)
